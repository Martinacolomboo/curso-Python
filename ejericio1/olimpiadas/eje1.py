print(int(input("ingrese los minutos: ")),int(input("ingrese los segundos: ")), int(input("ingrese las centesimas: ")))
print(int(input("ingrese los minutos: ")),int(input("ingrese los segundos: ")), int(input("ingrese las centesimas: ")))
print(int(input("ingrese los minutos: ")),int(input("ingrese los segundos: ")), int(input("ingrese las centesimas: ")))
...
#el .split() es para separar la informacion de los minutos,segundos y centesimas por seprado
