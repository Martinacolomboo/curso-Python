serie1=int(input("ingrese la cantidad de autos vendidos de RBM Serie 1: "))
serieplus=int(input("ingrese la cantidad de autos vendidos de RBM Serie Plus: "))
todoterreno=int(input("ingrese la cantidad de autos vendidos de RBM todoterreno: "))

preciototal1 = serie1 * 20000
preciototal2 = serieplus * 35000
preciototal3 = todoterreno * 60000

comision1 = (preciototal1 * 3) / 100
comision2 = (preciototal2 * 5) / 100
comision3 = (preciototal3 * 7) / 100

print("La comision a cobrar este mes es: ", comision1 + comision2 + comision3)
